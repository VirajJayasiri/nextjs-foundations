    ...
    <main className="flex flex-col gap-8 p-8">
      ...
      <section className="rounded-lg border bg-muted/50 p-6">
        ...
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-muted-foreground">
          <li>
            <strong>ExpandableWrapper (Client):</strong> Uses useState
            for expand/collapse
          </li>

          <li>
            <strong>Product Cards (Server):</strong> Static content
            with no interactivity
          </li>

          <li>
            <strong>Pattern:</strong> Server children pass through
            the client wrapper
          </li>
        </ul>
      </section>
